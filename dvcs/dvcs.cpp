...
namespace fizikci0147{
  ...
  void dvcs::Define(){
    ...
    _doToTopo["Electron:Proton:Photon1"]=[&](){
      ...
      ///////+++++++++++++++++++++++++++++++++++///////
        ...
        TD->MissMass=miss.M();
        TD->MissMass2=miss.M2();
        TD->pid_e = _electron.CLAS12()->getPid();
        TD->pid_p = _proton.CLAS12()->getPid();
        TD->xie = _electron.CLAS12()->par()->getChi2Pid();
        TD->xip = _proton.CLAS12()->par()->getChi2Pid();
        TD->Vz_e = _electron.CLAS12()->par()->getVz();
        TD->Vz_p = _proton.CLAS12()->par()->getVz();
        TD->th_e = _electron.CLAS12()->getTheta();
        TD->th_p = _proton.CLAS12()->getTheta();
        TD->phi_e = _electron.CLAS12()->getPhi();
        TD->phi_p = _proton.CLAS12()->getPhi();
        TD->region_p = _proton.CLAS12()->getRegion();
  ...
  void dvcs::Kinematics(){
    ...
    TD->Bjx =_kinCalc.Q2()/(2.*_target.M()*(qv.E()));
  }
    
  ///////////////////////$$$$$$$$$$$$$$$$$$$$$$$$$$//////////////////////  
  void dvcs::UserProcess(){
